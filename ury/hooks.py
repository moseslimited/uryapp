...
app_license = "MIT"
# Use a file that exists under /assets (the old Images/ury-logo.jpg path was missing → 404 in Desk).
...
doctype_js = {
	"POS Closing Entry": "public/js/pos_closing_entry_unpaid.js",
	"Website Settings": "public/js/website_settings_favicon_upload.js",
}
...
website_context = {"splash_image": "/assets/frappe/images/frappe-framework-logo.svg"}
...
override_doctype_class = {
	"POS Invoice": "ury.ury.override.pos_invoice.URYPosInvoice",
	"Sales Invoice": "ury.ury.override.sales_invoice.URYSalesInvoice",
	"POS Closing Entry": "ury.ury.override.pos_closing_entry.URYPosClosingEntry",
}
...
# --------------------------------
# After login, everyone lands on POS; Desk is still at /app or /desk.
on_login = ["ury.ury.hooks.ury_redirect.redirect_to_pos"]
        ...
        "filters": [
            [
                ...
                "in",
                {
                    ...
                    "POS Closing Entry-custom_ury_open_draft_pos_invoices",
...
# Zero COGS for BOM/manufactured items (Sales Invoice, Delivery Note, POS Invoice)
def _ury_apply_stock_cogs_patch():
	from ury.stock_cogs_patch import apply_patch
	apply_patch()


_ury_apply_stock_cogs_patch()
